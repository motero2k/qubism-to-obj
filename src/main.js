...
const { exportObj , exportMultiObj, uptateShapesJsonFile} = require("./main/objExporter");
...
const loadedQubismMultiObj3d = readQubismJsonToMultiObject3D("complicated-rounded",qubismScale);
